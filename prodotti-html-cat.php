...
<section class="productdetails-banner-main">
  <div class="container">
    <div class="row">
      <div class="col-xs-12 col-sm-12 col-md-12 col-lg-12">
        <div class="title-box">
          <h2>prodotti</h2>
          <p>SCEGLI IL PRODOTTO PER LE TUE ESIGENZE</p>
        </div>
      </div>
    </div>
  </div>
</section>
<section class="details-breadcrumb-main">
  <div class="container">
    <div class="row">
      <div class="col-xs-12 col-sm-12 col-md-12 col-lg-12">
        <ul>
...
<section class="product-details-main product-category-page">
  <div class="product-details-flex">
              ...
              <ul class="submenu">
                <li>
                  ...
                  <ul class="submenu">
                    ...
                    <li>
                      <a href="#">compressori b </a>
                    </li>
                    <li>
                      <a href="#">compressori c </a>
                    </li>
                    <li>
                      <a href="#">compressori d </a>
                    </li>
                  </ul>
                </li>
                <li>
    ...
    <div class="center-descrption-main">
      <div class="center-content-box">
        <div class="title-box mb-35">
          <h2>atlas copco</h2>
          <p>Compressori</p>
        </div>
      <div class="category-short-desc">
       ...
       <div class="product-category-grid">
            <div class="single-image-box">
                <a href="#">
                <img src="http://localhost/mmpozzi/wp-content/themes/bridge-child/assets/images/product-details/cat1.png" alt="">
